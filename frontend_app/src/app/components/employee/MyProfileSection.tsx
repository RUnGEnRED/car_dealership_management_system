...
import { useEmployeeProfile } from '../../hooks/employee/useEmployeeProfile'; // Ensure correct path
...
export const MyProfileSection: React.FC = () => {
  ...
  if (loading) {
    return <p className="text-gray-700">Loading employee profile...</p>;
  }
  if (error) {
    return <p className="text-red-600">Error: {error}</p>;
  }
  if (!profile) {
    return <p className="text-gray-700">No employee profile data available.</p>;
  }

  return (
    <div>
      <h2 className="text-2xl font-semibold text-gray-700 mb-4">My Employee Profile</h2>
      ...
      {editMode ? (
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <h3 className="text-lg font-semibold text-gray-700 mt-6 mb-2">Address:</h3>
          <div>
            <label htmlFor="street" className="block text-gray-700 text-sm font-bold mb-1">Street:</label>
            <input
              type="text"
              id="street"
              name="street"
        ...
        <div className="bg-gray-50 p-4 rounded-md mt-4 shadow-sm">
          ...
          <p className="text-gray-800 pl-4">
            {profile.address.postalCode || 'N/A'}, {profile.address.country || 'N/A'}
          </p>
